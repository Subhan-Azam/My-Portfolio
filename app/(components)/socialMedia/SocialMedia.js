...
export default function SocialMedia() {
  return (
    // <div>
    //   <div className="card">
    //     {/* <a href="#" target="_blank" className="socialContainer containerOne">
    ...
    <div className="card">
      ...
      >
        <FaWhatsapp className="svg social-icons" />
      </Link>
      ...
      >
        <FaLinkedinIn className="svg social-icons" />
      </Link>
    </div>
  );
}
